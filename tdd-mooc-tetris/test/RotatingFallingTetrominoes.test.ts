...
describe("Rotating Falling tetrominoes", () => {
  ...
  describe("I shape", () => {
    ...
    test("can wall kick if against another block 1", () => {
      const board = Board.loadBoard(
        `..........
         ..........
         ....I.....
    ...
    test("can wall kick if against another block 2", () => {
      const board = Board.loadBoard(
        `..........
         ..........
         ....I.....
    ...
    test("can wall kick against another block 3", () => {
      const board = Board.loadBoard(
        `..........
         ..........
         II........
    ...
    test("can double wall kick against another block", () => {
      const board = Board.loadBoard(
        `..........
         ..........
         II........
